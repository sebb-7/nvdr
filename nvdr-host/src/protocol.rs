...
mod tests {
    ...
    fn preserves_id_and_returns_capabilities() {
        let r = dispatch(
            req(r#"{"version":1,"request_id":"abc","operation":"capabilities"}"#),
            &Fake,
            &Fake,
            Capabilities::v1(),
        );
    ...
    fn rejects_unknown_operation() {
        let r = dispatch(
            req(r#"{"version":1,"request_id":"x","operation":"nope"}"#),
            &Fake,
            &Fake,
            Capabilities::v1(),
        );
    ...
    fn missing_process_is_structured() {
        let r = dispatch(
            req(r#"{"version":1,"request_id":"x","operation":"process.info","params":{"pid":99}}"#),
            &Fake,
            &Fake,
            Capabilities::v1(),
        );
