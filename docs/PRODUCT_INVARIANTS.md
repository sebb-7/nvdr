...
| ID | Status | Contract |
| --- | --- | --- |
| NVDA-001 | Partially enforced | NVDA forwarding is available only when the SSH-backed IPC channel is ready and the slave is ready; relay connection alone is not slave readiness. |
